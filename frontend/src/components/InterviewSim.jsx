...
export default function InterviewSim({ company, role, jobDescription, onClose }) {
  ...
  if (phase === 'complete') return (
    <div style={{ padding: '28px 24px', overflowY: 'auto', maxHeight: 600 }}>
      ...
      <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
        <button onClick={() => { setPhase('start'); setScores([]); setCurrentQ(0); setAnswer(''); }} className="btn btn-ghost" style={{ flex: 1 }}>
  ...
  return (
    <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16, minHeight: 480 }}>
      {/* Progress bar */}
      <div>
